...
export const STRENGTH_EXERCISES = {
  ...
  abWheel: {
    ...
    isUnilateral: false,
    weightIncrement: 0,
    // Rolling out on the knees — most of him, through a long lever.
    bodyweightLoad: 0.65,
    demands: D('low', 'low', 'low', 'moderate'),
    notes: 'Anti-extension under a long lever. Progresses by range before it progresses by load.',
    cue: 'Ribs down and hips tucked the whole way out. Stop before the low back gives.',
  },
  hollowHold: {
    id: 'hollowHold',
    ...
    repRange: [20, 60],
    demands: D('low', 'low', 'low', 'low'),
    notes: 'The position a runner loses at hour five — ribs down, pelvis tucked, nothing sagging.',
    cue: 'Low back pinned to the floor. Lower the legs only as far as it stays pinned.',
  },
  reverseCrunch: {
    id: 'reverseCrunch',
    name: 'Reverse Crunch',
    shortName: 'Rev Crunch',
    chain: CHAINS.NEUTRAL,
    pattern: PATTERNS.CORE,
    tier: 'isolation',
    muscles: { primary: ['core'], secondary: [] },
    ...
    bodyweightLoad: 0.35,
    demands: D('low', 'low', 'low', 'low'),
    notes: 'Flexion from the bottom up, which reaches the lower abs a cable crunch mostly misses.',
    cue: 'Curl the pelvis off the floor. No swinging the legs for momentum.',
  },
  cableChop: {
    id: 'cableChop',
    ...
    demands: D('low', 'low', 'low', 'low'),
    notes:
      'Rotary control under load rather than a static hold — closer to what an ' +
      'arm swing asks the trunk to resist every stride.',
    cue: 'Hips square and still. The arms move, the pelvis does not.',
  },
  birdDog: {
    id: 'birdDog',
    name: 'Bird Dog',
    ...
    bodyweightLoad: 0.2,
    demands: D('low', 'low', 'low', 'low'),
    notes: 'Contralateral limbs loaded — the same diagonal the trunk resists on every stride.',
    cue: 'Slow. A glass of water on the low back should not spill.',
  },
  suitcaseCarry: {
    id: 'suitcaseCarry',
    name: 'Suitcase Carry',
    ...
    tier: 'accessory',
    muscles: { primary: ['core'], secondary: ['traps'] },
    equipment: ['dumbbell'],
    equipmentLevel: 'minimal',
    isUnilateral: true,
    perSide: true,
    ...
    demands: D('low', 'low', 'low', 'moderate'),
    notes:
      'Loaded on one side only — anti-lateral flexion while walking, which is a ' +
      'vest, a bottle or a pack in every practical sense.',
    cue: 'Seconds per side. Shoulders level; do not lean away from the weight.',
  },
  farmersCarry: {
    id: 'farmersCarry',
    name: "Farmer's Carry",
